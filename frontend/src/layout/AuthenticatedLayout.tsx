  ...
  return (
    <div className="min-h-screen overflow-x-hidden bg-gray-50 text-gray-900">
      <aside className="fixed inset-y-0 left-0 z-30 hidden w-64 flex-col bg-navy text-white lg:flex">
        <div className="flex h-16 items-center gap-3 border-b border-white/15 px-5"><img className="h-10 w-10 object-contain" src={ktunLogo} alt="Konya Teknik Üniversitesi" /><div className="leading-tight"><p className="text-sm font-bold tracking-wide">KTUN PORTAL</p><p className="text-[10px] text-white/60">YÖNETİM BİLGİ SİSTEMİ</p></div></div>
