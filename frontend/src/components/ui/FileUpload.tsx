...
export function FileUpload({ label, onFilesSelected, accept, multiple = false, disabled = false, error }: FileUploadProps) {
  const inputId = useId()
  ...
  return (
    <div className="w-full">
      ...
      >
        ...
        <span className="mt-1 text-xs text-gray-500">PDF veya desteklenen belge yükleyin</span>
        <input
          id={inputId}
          type="file"
          className="sr-only"
